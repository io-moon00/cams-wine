"""
Django settings for camswine project.
...
with open('wine_config.json') as config_file:
...
CSRF_TRUSTED_ORIGINS=['https://camswine.de']
...
WSGI_APPLICATION = 'camswine.wsgi.application'
...
# Recaptcha
RECAPTCHA_PUBLIC_KEY = '6LcNSUEpAAAAAMuTaUDc4GOPRcnKmC9Csaj09YuN'
